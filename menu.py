        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    quantity = input(f"How many of these {selection_item} would you like? ")
...
for i in range(len(order_list)):
    ...
    number_price_spaces =  7 - len(str(price))
...
costs = [price * quantity for price, quantity in [(price, quantity)]]
